...
However, to lower the variance of user-visible latency and handle 
intermittent failures, storage systems designed for large clusters 
opt for 'eventual consistency' using non-overlapping read and write 
sets. Further, operators are required to choose a fixed number of 
read/write replicas to maintain the target latencies. 

In this work we present 'Ernst', a replica-management policy that
